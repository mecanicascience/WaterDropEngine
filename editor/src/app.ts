...
function receivedMessage({ identifier, title, payload } : { identifier: number, title: number, payload: Buffer }, socket: string) {
...
export function createIPCServer() {
    ...
    ipc.serve(
        ...
        function () {
            ...
            ipc.server.on(
                'socket.disconnected',
                function (socket: string, destroyedSocketID: string) {
