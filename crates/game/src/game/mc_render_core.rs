use bevy::prelude::*;
use wde_render::{assets::{GpuBuffer, GpuTexture, RenderAssets, RenderAssetsPlugin}, core::{Render, RenderApp, RenderSet, SwapchainFrame}, features::CameraFeatureRender, pipelines::{CachedPipelineStatus, PipelineManager}, renderer::depth::DepthTexture};
...
pub struct MarchingCubesPluginRender;
impl Plugin for MarchingCubesPluginRender {
